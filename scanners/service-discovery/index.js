...
async function processProjects(projects) {
    for (const project of projects){
        ...
        // const upsertServiceInDatabase = await upsertIntoDatabase(project, graphQLClient)
        
        // TODO fix return to be _key or serviceName instead (or more human understandable)
        // const serviceName = upsertServiceInDatabase.upsertService // serviceName is the database key for services collection
        const serviceName = 'needToFixThis'
